...
import Section from './containers/Grammer.Section';
...
export default new Map([
  ['Norwegian Alphabets', (
    <Section dataID={0} key={0} caption="Norwegian Alphabets">
  ...
  ['Conversation I - Greetings & Common Phrases', (
    <Section dataID={1} key={1} caption="Conversation I - Greetings & Common Phrases">
  ...
  ['Personal Pronouns (Pronomen)', (
    <Section dataID={2} key={2} caption="Personal Pronouns (Pronomen)">
  ...
  ['Nouns (Substantiv)', (
    <Section dataID={3} key={3} caption="Nouns (Substantiv)">
  ...
  ['Verbs', (
    <Section dataID={4} key={4} caption="Verbs">
      Verbs
    </Section>
  )],
  ['Forming Sentences', (
    <Section dataID={5} key={5} caption="Forming Sentences">
      Forming Sentences
    </Section>
  )]
]);